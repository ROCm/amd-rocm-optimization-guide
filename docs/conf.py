...
extensions = ["rocm_docs", "sphinxcontrib.datatemplates", "version-ref", "csv-to-list-table", "rocm_docs.remote_content", "svg-pdf-converter", "sphinx_subfigure", "sphinx_substitution_extensions"]
...
html_theme_options = {
    ...
    "flavor": "generic",
    "header_title": "AMD ROCm™ Optimization Guide",
    "header_link": "https://rocm.docs.amd.com/projects/amd-rocm-optimization-guide/en/latest/",
    "version_list_link": False,
    "nav_secondary_items": {
        "GitHub": "https://github.com/ROCm/amd-rocm-optimization-guide",
