...
* Understanding of HIP programming fundamentals.

* Familiarity with GPU architecture concepts.

* HIP runtime environment installed.

* Basic knowledge of performance profiling concepts (recommended).

For comprehensive documentation on ROCm installation and HIP programming fundamentals,
see the `ROCm documentation portal <https://rocm.docs.amd.com>`__.
