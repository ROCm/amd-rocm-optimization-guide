...
********************************************************************************
CDNA and CDNA2 sparse MFMA intrinsics
********************************************************************************
...
The intrinsics on this page target CDNA (``gfx908``, MI100) and CDNA2
(``gfx90a``, MI200 series).  Equivalent intrinsics for later CDNA
...
.. _cdna-smfmac-intrinsic-reference:
