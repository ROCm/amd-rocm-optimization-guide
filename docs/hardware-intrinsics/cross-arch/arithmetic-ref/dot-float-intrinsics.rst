.. meta::
   :description: Reference for AMD GPU floating-point dot product intrinsics,
      including fdot2 for FP16, BF16, FP8, and BF8 types with usage and architecture availability.
   :keywords: AMD, ROCm, HIP, dot product, floating-point, fdot2, FP16, BF16, FP8, BF8, intrinsics, CDNA, RDNA

.. _dot-float-intrinsics:

********************************************************************************
Floating-point dot product intrinsics
********************************************************************************

The floating-point dot product intrinsics compute inner products of packed
...
Most floating-point dot product intrinsics share the following parameters:
