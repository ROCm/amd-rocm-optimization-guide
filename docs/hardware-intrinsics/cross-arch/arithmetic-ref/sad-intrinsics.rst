.. meta::
   :description: Reference for AMD GPU sum of absolute differences intrinsics,
      including msad_u8, sad_u8, sad_hi_u8, and qsad with usage and architecture availability.
   :keywords: AMD, ROCm, HIP, SAD, sum of absolute differences, msad_u8, sad_u8, intrinsics, CDNA, RDNA

.. _sad-intrinsics:

********************************************************************************
Sum of absolute differences intrinsics
********************************************************************************

The SAD intrinsics compute the L1 distance between packed byte vectors in a
...
All SAD intrinsics share the same three-operand pattern:
