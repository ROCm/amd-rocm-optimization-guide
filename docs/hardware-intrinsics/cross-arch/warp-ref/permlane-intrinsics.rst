.. meta::
   :description: Reference for AMD GPU cross-row permutation intrinsics,
      including permlane16, permlanex16, and permlane64 with usage details and architecture availability.
   :keywords: AMD, ROCm, HIP, permlane16, permlanex16, permlane64, cross-row permutation, warp, intrinsics, CDNA, RDNA

.. _permlane-intrinsics:

********************************************************************************
Cross-row permutation intrinsics
********************************************************************************

The permlane intrinsics move data across 16-lane row boundaries, complementing
