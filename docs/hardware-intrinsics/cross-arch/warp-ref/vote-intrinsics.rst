.. meta::
   :description: Reference for AMD GPU warp voting and synchronization intrinsics,
      including ballot, inverse_ballot, mbcnt, and wave_barrier with architecture support.
   :keywords: AMD, ROCm, HIP, ballot, mbcnt, warp voting, wave_barrier, synchronization, intrinsics, CDNA, RDNA

.. _vote-intrinsics:

********************************************************************************
Warp voting and synchronization intrinsics
********************************************************************************

Warp voting intrinsics answer the question "which lanes satisfy a condition?"
by converting per-lane predicates into bitmasks, and vice versa.  The
``ballot`` intrinsic captures a predicate as a bitmask; ``mbcnt`` counts the
...
These intrinsics convert per-lane predicates into bitmasks and vice versa.
...
These intrinsics count set bits in a ballot mask below the current lane to produce compaction indices.
...
These intrinsics provide warp-level synchronization and identification.
