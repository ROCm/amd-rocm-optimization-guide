.. RST include fragment -- do not add to toctree.
   Intrinsic: __builtin_amdgcn_wmma_f32_16x16x16_bf16_w32
   Include via: .. include:: wmma-ref/f32-16x16x16bf16-rdna3.rst
...
.. list-table::
   ...
   * - ``srcA``
     - v16short
     - Sixteen BF16 elements of :math:`\pmb{A}` per lane (BF16 stored as
       ``short``).
   * - ``srcB``
     - v16short
