<head>
  <meta charset="UTF-8">
  <meta name="description" content="Contributing to the AMD ROCm Optimization Guide">
  <meta name="keywords" content="AMD ROCm Optimization Guide, contributing, contribute, maintainer, contributor">
</head>

# Contributing to the AMD ROCm Optimization Guide
...
The AMD ROCm Optimization Guide uses GitHub to host code, collaborate, and manage
version control. We use pull requests (PRs) for all changes within our
repositories. We use [GitHub issues](https://github.com/ROCm/amd-rocm-optimization-guide/issues)
to track known issues, such as bugs.

### Issue tracking

Before filing a new issue, search the
[existing issues](https://github.com/ROCm/amd-rocm-optimization-guide/issues) to
